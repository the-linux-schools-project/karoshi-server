 ...
 * @subpackage accounts
 * @access public
 * @version $Id: class.accounts.inc.php 24346 2007-07-27 09:36:33Z ralfbecker $
 */
...
//'n_given'    => $data['account_firstname'],
			...
			'account_lastname'      => $GLOBALS['auto_create_acct']['lastname'] ? $GLOBALS['auto_create_acct']['lastname'] : ' ',
