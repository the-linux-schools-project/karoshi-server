...
<div id="headerbar">
	<div id="headerbar1">
&nbsp;&nbsp;<a href="/cgi-bin/menu.cgi" target="_top"><img style="border: 0px solid ; width: 16px; height: 16px;" alt="" src="/images/home.png"></a>&nbsp;&nbsp;<a href="/cgi-bin/admin/search_fm.cgi" target="_top"><img style="border: 0px solid ; width: 16px; height: 16px;" alt="" src="/images/search.png"></a>&nbsp;&nbsp;'$"DE"'&nbsp;&nbsp; - &nbsp;&nbsp;'$"Web Management"' <small><small>'$VERSION ':' 280509-0838'</small></small>
	</div>'
