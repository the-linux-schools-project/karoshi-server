...
[ -f /opt/karoshi/web_controls/language/$LANGCHOICE/menus/asset_register ] || LANGCHOICE=englishuk
source /opt/karoshi/web_controls/language/$LANGCHOICE/menus/asset_register
############################
#Show page
############################
...
<a href="/cgi-bin/admin/asset_register_add_supplier_fm.cgi" target="_top"><img style="border: 0px solid ; width: 16px; height: 16px;" alt="" src="/images/submenus/client/domain_information.png">'$ADDDSUPPLIER'</a><br>
<a href="/cgi-bin/admin/asset_register_add_budget_fm.cgi" target="_top"><img style="border: 0px solid ; width: 16px; height: 16px;" alt="" src="/images/submenus/client/domain_information.png">'$ADDBUDGET'</a><br>
<a href="/cgi-bin/admin/asset_register_delete_description_fm.cgi" target="_top"><img style="border: 0px solid ; width: 16px; height: 16px;" alt="" src="/images/submenus/client/domain_information.png">'$DELDESC'</a><br>
<a href="/cgi-bin/admin/asset_register_delete_supplier_fm.cgi" target="_top"><img style="border: 0px solid ; width: 16px; height: 16px;" alt="" src="/images/submenus/client/domain_information.png">'$DELETESUPPLIER'</a><br>
<a href="/cgi-bin/admin/asset_register_delete_budget_fm.cgi" target="_top"><img style="border: 0px solid ; width: 16px; height: 16px;" alt="" src="/images/submenus/client/domain_information.png">'$DELETEBUDGET'</a><br>
