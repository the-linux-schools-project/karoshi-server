...
#
system "[ -d /var/www/karoshi/linux_background_upload ] && rm -f -R /var/www/karoshi/linux_background_upload";
system "mkdir -p /var/www/karoshi/linux_background_upload";
system "chmod 0700 /var/www/karoshi/";
system "chmod 0700 /var/www/karoshi/linux_background_upload";

BEGIN {

	$SAVE_DIRECTORY = "/var/www/karoshi/linux_background_upload";
                              #
                              # --> Variable:
                              #         $SAVE_DIRECTORY
                              # --> Function:
...
<!DOCTYPE html><html><head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
			<TITLE>Upload Completed</TITLE><meta http-equiv="REFRESH" content="0; URL=/cgi-bin/admin/linux_client_background_upload2.cgi">
		</HEAD>
