...
echo '<b>'$MESSAGE'</b><br>'
echo '<form action="/cgi-bin/admin/dg_ban_user.cgi" method="post">'
...
getent passwd $STUDENT_USERNAME 1>/dev/null 2>/dev/null
STUDENTSTATUS=`echo $?`
if [ $STUDENTSTATUS != 0 ]
then
...
sudo -H /opt/karoshi/web_controls/exec/dg_ban_user $REMOTE_USER:$REMOTE_ADDR:$MD5SUM:$DAY:$MONTH:$YEAR:$HOUR:$MINUTES:$INCIDENT:$ACTIONTAKEN:$STUDENTS:$BANLENGTH
