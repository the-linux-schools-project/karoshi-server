...
#
system "[ -d /var/www/karoshi/ppd_files ] && rm -f -R /var/www/karoshi/ppd_files";
system "mkdir -p /var/www/karoshi/ppd_files";
system "chmod 0700 /var/www/karoshi/";
system "chmod 0700 /var/www/karoshi/ppd_files";
BEGIN {

	$SAVE_DIRECTORY = "/var/www/karoshi/ppd_files";
                              #
                              # --> Variable:
                              #         $SAVE_DIRECTORY
                              # --> Function:
...
<!DOCTYPE html><html><head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
			<TITLE>Upload Completed</TITLE><meta http-equiv="REFRESH" content="0; URL=printers_ppd_upload3.cgi">
		</HEAD>
