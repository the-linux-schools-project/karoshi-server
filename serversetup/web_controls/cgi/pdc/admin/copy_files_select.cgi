...
echo ""
echo '<!DOCTYPE html><html><head><meta http-equiv="Content-Type" content="text/html; charset=utf-8"><title>'$"Copy Files - Select"'</title><meta http-equiv="REFRESH" content="0; URL=/cgi-bin/admin/copy_files_upload_fm.cgi"><link rel="stylesheet" href="/css/'$STYLESHEET'?d='$VERSION'"><script src="/all/stuHover.js" type="text/javascript"></script></head>'
#########################
#Get data input
#########################
...
if [ $EXEC_STATUS = 0 ]
then
MESSAGE=`echo $"The data has been copied to all accounts in the selected group."`
else
MESSAGE=`echo $"There was a problem copying the files to the group."`
fi
show_status
