...
<!DOCTYPE html><html><head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  <title>'$"Network Share Logs"'</title><meta http-equiv="REFRESH" content="'$TIMEOUT'; URL=/cgi-bin/admin/logout.cgi">
...
echo '<form action="/cgi-bin/admin/samba_logs_share.cgi" name="testform" method="post"><b></b>
  <div id="actionbox"><b>'$"Network Share Logs"'</b> <a class="info" href="javascript:void(0)"><img class="images" alt="" src="/images/help/info.png"><span>'$"Connection logs are generated each time a user connects to a share."'</span></a>
<br><br>

<table class="standard" style="text-align: left;" >
    <tbody>
<tr><td style="width: 180px;">'$"Share"'</td><td><input tabindex= "1" name="_SHARE_" size="14" type="text"></td><td style="vertical-align: top; text-align: center;"><a class="info" href="javascript:void(0)"><img class="images" alt="" src="/images/help/info.png"><span>'$"Enter in the network share name that you want to check the logs for."'</span></a></td></tr>'
