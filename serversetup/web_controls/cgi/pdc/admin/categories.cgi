...
<div class="sectiontitle">'$"Categories"' <a class="info" target="_blank" href="http://www.linuxschools.com/karoshi/documentation/wiki/index.php?title=Categories"><img class="images" alt="" src="/images/help/info.png"><span>'$"Categories are sub containers in OU=People in the ldap structure."'</span></a></div>
