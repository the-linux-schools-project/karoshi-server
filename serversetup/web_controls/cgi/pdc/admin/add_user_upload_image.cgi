...
#
system "[ -d /var/www/karoshi/add_user_image/$ENV{REMOTE_USER} ] && rm -f -R /var/www/karoshi/add_user_image/$ENV{REMOTE_USER}";
system "mkdir -p /var/www/karoshi/add_user_image/$ENV{REMOTE_USER}";
system "chmod 0700 /var/www/karoshi/";
system "chmod 0700 /var/www/karoshi/add_user_image/$ENV{REMOTE_USER}";
BEGIN {

	$SAVE_DIRECTORY = "/var/www/karoshi/add_user_image/$ENV{REMOTE_USER}";
                              #
                              # --> Variable:
                              #         $SAVE_DIRECTORY
                              # --> Function:
...
<!DOCTYPE html><html><head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
			<TITLE>Upload Completed</TITLE><meta http-equiv="REFRESH" content="0; URL=add_user_upload_image_fm.cgi">
		</HEAD>
		<BODY>
		</BODY>
		</HTML>
