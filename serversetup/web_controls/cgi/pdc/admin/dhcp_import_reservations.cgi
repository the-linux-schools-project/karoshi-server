...
#
system "[ -d /var/www/karoshi/dhcp-static_lease_import ] && rm -f -R /var/www/karoshi/dhcp-static_lease_import";
system "mkdir -p /var/www/karoshi/dhcp-static_lease_import";
system "chmod 0700 /var/www/karoshi/";
system "chmod 0700 /var/www/karoshi/dhcp-static_lease_import";
BEGIN {

	$SAVE_DIRECTORY = "/var/www/karoshi/dhcp-static_lease_import";
                              #
                              # --> Variable:
                              #         $SAVE_DIRECTORY
                              # --> Function:
...
<!DOCTYPE html><html><head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
			<TITLE>Upload Completed</TITLE><meta http-equiv="REFRESH" content="0; URL=dhcp_import_reservations_process.cgi">
		</HEAD>
