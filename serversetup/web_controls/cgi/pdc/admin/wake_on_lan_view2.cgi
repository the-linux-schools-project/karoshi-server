...
echo ""
echo '<!DOCTYPE html><html><head><meta http-equiv="Content-Type" content="text/html; charset=utf-8"><title>'$"View Banned Users"'</title><meta http-equiv="REFRESH" content="0; URL='$HTTP_REFERER'"<link rel="stylesheet" href="/css/$STYLESHEET"></head><body><div id="pagecontainer">'
#########################
#Get data input
#########################
