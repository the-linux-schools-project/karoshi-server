...
<!DOCTYPE html><html><head><meta charset="UTF-8">
  <title>'$"E-Mail Policy Rules"'</title><meta http-equiv="REFRESH" content="'$TIMEOUT'; URL=/cgi-bin/admin/logout.cgi">
...
echo '<script>
alert("'$MESSAGE'");
window.location = "/cgi-bin/admin/postfwd.cgi";
...
then
	echo '<div style="float: center" id="my_menu" class="sdmenu">
		<div class="expanded">
		<span>'$"E-Mail Policy Rules"' '$SERVER2'</span><a href="/cgi-bin/admin/mobile_menu.cgi">'$"Menu"'</a>
	</div></div>
	<div id="'$DIV_ID'">
	'
	...
	<tr>
	<td style="height:30px;"><div class="sectiontitle">'$"E-Mail Policy Rules"'</div></td>
	<td><a class="info" target="_blank" href="http://www.linuxschools.com/karoshi/documentation/wiki/index.php?title=Firewall_Rules"><img class="images" alt="" src="/images/help/info.png"><span>'$"E-Mail Policy Rules"'</span></a></td>'

	if [ "$SERVERNAME" != notset ]
	then
		echo '
	<td>
	<form action="/cgi-bin/admin/postfwd.cgi" method="post">
...
echo '<form action="/cgi-bin/admin/postfwd.cgi" method="post">'
