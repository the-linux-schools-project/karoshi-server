...
<table class="standard" style="text-align: left;" ><tbody>
	<tr><td><div class="sectiontitle">'$"Archive exam accounts"'</div></td><td><a class="info" target="_blank" href="http://www.linuxschools.com/karoshi/documentation/wiki/index.php?title=Archive_Exam_Accounts"><img class="images" alt="" src="/images/help/info.png"><span>'$"All data will be archived from the exam accounts to an examfiles folder in the network share that you choose."'<br><br>'$"Only a member of the selected group can access this folder."'</span></a></td></tr></tbody></table><br><br>
