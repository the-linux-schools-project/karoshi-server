...
[ -f /opt/karoshi/web_controls/language/$LANGCHOICE/internet/dg_view_banned_sites ] || LANGCHOICE=englishuk
source /opt/karoshi/web_controls/language/$LANGCHOICE/internet/dg_view_banned_sites
...
echo '<form action="/cgi-bin/admin/dg_view_banned_sites.cgi" name="selectedsites" method="post">
...
<table class="standard" style="text-align: left; width: 100px;" border="0"
 cellpadding="2" cellspacing="2">
  <tbody>
    <tr>
      <td>'$STUDENTSTITLE'</td>
      <td><input checked="checked" name="_GROUP_"
 value="students" type="radio"></td>
    </tr>
    <tr>
      <td>'$STAFFTITLE'</td>
      <td><input name="_GROUP_" value="staff"
 type="radio"></td>
    </tr></tbody></table><br>
