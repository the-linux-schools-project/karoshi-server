...
echo '<form action="/cgi-bin/admin/software_raid_create.cgi" name="selectservers" method="post"><b></b>
...
<button class="button" formaction="software_raid_control_fm.cgi" name="ControlRaid" value="_">
'$"Control Software Raid"'
</button>
