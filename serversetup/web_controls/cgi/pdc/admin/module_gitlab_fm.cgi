...
echo '<form  id="form1" name="combobox" action="/cgi-bin/admin/module_gitlab.cgi" method="post"><div id="actionbox3"><div id="titlebox">
...
<b>'$"Description"'</b><br>
<br>This will setup a Gitlab Server (CE 8.5.1 Omnibus).<br>
...
<tbody><tr><td style="width: 180px;">'$"Gitlab Domain"'</td><td>'

echo '<input type="text" name="_ALIAS_" style="width: 200px;" value="" size="10"></td><td>.'"$REALM"'</td><td><a class="info" target="_blank" href="http://www.linuxschools.com/karoshi/documentation/wiki/index.php?title=Gitlab_Server"><img class="images" alt="" src="/images/help/info.png"><span>'$"You will need to choose an alias for this server for web access. Either enter in a custom alias or choose one from the dropdown list."'</span></a></td></tr>
...
echo '</select></td><td></td><td></td></tr></tbody></table><br><br><input value="'$"Submit"'" class="button" type="submit"></div></div></div></form></div></body></html>'
exit
