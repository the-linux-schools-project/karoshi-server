...
do
	...
	#View logs
	echo "$REMOTE_USER:$REMOTE_ADDR:$Checksum:$DAY:$MONTH:$YEAR:" | sudo -H /opt/karoshi/web_controls/exec/dg_view_global_usage
	EXEC_STATUS="$?"
	if [ "$EXEC_STATUS" = 101 ]
	then
