...
<!DOCTYPE html><html><head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  <title>'$"Setup Kanboard"'</title><meta http-equiv="REFRESH" content="'"$TIMEOUT"'; URL=/cgi-bin/admin/logout.cgi">
...
echo '<form id="form1" name="combobox" action="/cgi-bin/admin/module_kanboard.cgi" method="post"><div id="actionbox3"><div id="titlebox"><div class="sectiontitle">'$"Setup Kanboard"' - '"$SERVERNAME"'</div>
