...
echo '<div id="actionbox3"><div id="titlebox"><div class="sectiontitle">'$"Setup Kanboard"'</div><br></div><div id="infobox">'
...
echo "$REMOTE_USER:$REMOTE_ADDR:$Checksum:$SERVERNAME:$ALIAS" | sudo -H /opt/karoshi/web_controls/exec/module_kanboard
