...
#
system "[ -d /var/www/karoshi/karoshi_patches ] && rm -f -R /var/www/karoshi/karoshi_patches";
system "mkdir -p /var/www/karoshi/karoshi_patches";
system "chmod 0700 /var/www/karoshi/";
system "chmod 0700 /var/www/karoshi/karoshi_patches";
BEGIN {

	$SAVE_DIRECTORY = "/var/www/karoshi/karoshi_patches";
                              #
                              # --> Variable:
                              #         $SAVE_DIRECTORY
                              # --> Function:
