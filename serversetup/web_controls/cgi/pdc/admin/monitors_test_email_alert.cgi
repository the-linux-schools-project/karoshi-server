...
Checksum=`sha256sum /var/www/cgi-bin_karoshi/admin/monitors_test_email_alert.cgi | cut -d' ' -f1`
#Test alert information
echo "$REMOTE_USER:$REMOTE_ADDR:$Checksum:$NAME:" | sudo -H /opt/karoshi/web_controls/exec/monitors_test_email_alert
EXEC_STATUS=`echo $?`
