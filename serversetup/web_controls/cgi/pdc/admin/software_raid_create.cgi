...
echo 'alert("'$MESSAGE'")';
echo '                window.location = "/cgi-bin/admin/software_raid_create_fm.cgi";'
echo '</script>
'
echo "</div></body></html>"
exit
...
echo "$REMOTE_USER:$REMOTE_ADDR:$Checksum:$SERVERNAME:$SERVERTYPE:$SERVERMASTER:" | sudo -H /opt/karoshi/web_controls/exec/software_raid_create
