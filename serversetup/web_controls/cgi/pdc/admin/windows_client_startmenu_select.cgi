...
sudo -H /opt/karoshi/web_controls/exec/windows_client_startmenu_select $REMOTE_USER:$REMOTE_ADDR:$Checksum:$FILENAME:$WINDOWSVER:`echo ${PRIGROUP[@]:0} | sed 's/ /:/g'`
EXEC_STATUS=`echo $?`
if [ $EXEC_STATUS = 0 ]
then
MESSAGE=`echo $"The selected start menu has been copied to all of the chosen groups."`
else
