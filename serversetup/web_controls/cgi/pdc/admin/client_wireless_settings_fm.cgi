...
'
	...
	echo '<div id="'"$DIV_ID"'"><div id="titlebox"><div class="sectiontitle">'$"Client Wireless Settings"' <a class="info" target="_blank" href="http://www.linuxschools.com/karoshi/documentation/wiki/index.php?title=Client_Wireless_Settings"><img class="images" alt="" src="/images/help/info.png"><span>'$"This will save the wifi information on the netlogon share for your clients to use when accessing wifi access points."'</span></a></div><br><br>'
fi
...
<a class="'"$TOOLTIPCLASS"'" target="_blank" href="http://www.linuxschools.com/karoshi/documentation/wiki/index.php?title=Client_Wireless_Settings"><img class="images" alt="" src="/images/help/info.png"><span>'$"Enter in the wifi key for your wireless access points."'</span></a></td></tr></tbody></table><br><br>
