...
#
system "[ -d /var/www/karoshi/classroom_lists ] && rm -f -R /var/www/karoshi/classroom_lists";
system "mkdir -p /var/www/karoshi/classroom_lists";
system "chmod 0700 /var/www/karoshi/";
system "chmod 0700 /var/www/karoshi/classroom_lists";
BEGIN {

	$SAVE_DIRECTORY = "/var/www/karoshi/classroom_lists";
                              #
                              # --> Variable:
                              #         $SAVE_DIRECTORY
                              # --> Function:
...
<!DOCTYPE html><html><head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
			<TITLE>Upload Completed</TITLE><meta http-equiv="REFRESH" content="0; URL=generate_classroom_lists_csv_process.cgi">
		</HEAD>
