...
#
system "[ -d /var/www/karoshi/linuxiso ] && rm -f -R /var/www/karoshi/linuxiso";
system "mkdir -p /var/www/karoshi/linuxiso";
system "chmod 0700 /var/www/karoshi/";
system "chmod 0700 /var/www/karoshi/linuxiso";
BEGIN {

	$SAVE_DIRECTORY = "/var/www/karoshi/linuxiso";
                              #
                              # --> Variable:
                              #         $SAVE_DIRECTORY
                              # --> Function:
...
<!DOCTYPE html><html><head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
			<TITLE>Upload Completed</TITLE><meta http-equiv="REFRESH" content="0; URL=/cgi-bin/admin/linux_client_upload_distro2.cgi">
		</HEAD>
