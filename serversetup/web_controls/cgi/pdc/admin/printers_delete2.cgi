...
echo ""
echo '<!DOCTYPE html><html><head><meta http-equiv="Content-Type" content="text/html; charset=utf-8"><title>'$"Delete a Network Printer"'</title><link rel="stylesheet" href="/css/'$STYLESHEET'?d='$VERSION'"></head><body>'
#########################
#Get data input
#########################
