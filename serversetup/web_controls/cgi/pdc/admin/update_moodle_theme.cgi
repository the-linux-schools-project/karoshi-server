...
#
system "[ -d /var/www/karoshi/moodle_theme ] && rm -f -R /var/www/karoshi/moodle_theme";
system "mkdir -p /var/www/karoshi/moodle_theme";
system "chmod 0700 /var/www/karoshi/";
system "chmod 0700 /var/www/karoshi/moodle_theme";
BEGIN {

	$SAVE_DIRECTORY = "/var/www/karoshi/moodle_theme";
                              #
                              # --> Variable:
                              #         $SAVE_DIRECTORY
                              # --> Function:
...
<!DOCTYPE html><html><head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
			<TITLE>Upload Completed</TITLE><meta http-equiv="REFRESH" content="0; URL=update_moodle_theme_process1.cgi">
		</HEAD>
