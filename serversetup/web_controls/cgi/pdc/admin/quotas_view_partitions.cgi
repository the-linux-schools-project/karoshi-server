...
echo ""
echo '<!DOCTYPE html><html><head><meta http-equiv="Content-Type" content="text/html; charset=utf-8"><title>'$"View Quota Enabled Partitions"'</title><link rel="stylesheet" href="/css/'$STYLESHEET'?d='`date +%F`'">
