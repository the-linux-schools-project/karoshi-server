...
then
	...
	ICON5=/images/submenus/system/logs.png
	#Generate navigation bar
	/opt/karoshi/web_controls/generate_navbar_admin
else
	DIV_ID=mobileactionbox
	WIDTH=90
	ICON4=/images/submenus/system/addm.png
	ICON5=/images/submenus/system/logsm.png
fi
...
then
	...
	<div class="sectiontitle">'$"Internet Usage Trends"' <a class="info" target="_blank" href="http://www.linuxschools.com/karoshi/documentation/wiki/index.php?title=Internet_Usage_Trends"><img class="images" alt="" src="/images/help/info.png"><span>'$"Internet Usage Trends"'</span></a></div>
