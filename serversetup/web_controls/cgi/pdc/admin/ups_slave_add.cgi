...
echo ""
echo '<!DOCTYPE html><html><head><meta http-equiv="Content-Type" content="text/html; charset=utf-8"><title>'$"Add a slave UPS"'</title><link rel="stylesheet" href="/css/'$STYLESHEET'?d='$VERSION'"><meta http-equiv="REFRESH" content="0;url=/cgi-bin/admin/ups_status.cgi"></head><body><div id="pagecontainer">'
#########################
#Get data input
#########################
...
echo '<div id="actionbox"><b>'$"Add a slave UPS"'</b><br>'
Checksum=`sha256sum /var/www/cgi-bin_karoshi/admin/ups_slave_add.cgi | cut -d' ' -f1`
#Add UPS
echo "$REMOTE_USER:$REMOTE_ADDR:$Checksum:$UPSSERVER:$SERVERNAME:" | sudo -H /opt/karoshi/web_controls/exec/ups_slave_add
EXEC_STATUS=`echo $?`
