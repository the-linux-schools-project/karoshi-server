...
echo ""
echo '<!DOCTYPE html><html><head><meta http-equiv="Content-Type" content="text/html; charset=utf-8"><title>'$"Add Network Printer"'</title><link rel="stylesheet" href="/css/'$STYLESHEET'?d='$VERSION'"></head><body><div id="pagecontainer">'
#########################
#Get data input
#########################
...
#Add printer
sudo -H /opt/karoshi/web_controls/exec/printers_add $REMOTE_USER:$REMOTE_ADDR:$Checksum:$PRINTERNAME:$LOCATION:$PRINTERADDRESS:$PRINTERQUEUE:$PRINTERDESC:$PRINTERTYPE:$PRINTERPORT
EXEC_STATUS=`echo $?`
if [ $EXEC_STATUS = 101 ]
then
