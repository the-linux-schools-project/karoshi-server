...
#
system "[ -d /var/www/karoshi/win_background_upload ] && rm -f -R /var/www/karoshi/win_background_upload";
system "mkdir -p /var/www/karoshi/win_background_upload";
system "chmod 0700 /var/www/karoshi/";
system "chmod 0700 /var/www/karoshi/win_background_upload";

BEGIN {

	$SAVE_DIRECTORY = "/var/www/karoshi/win_background_upload";
                              #
                              # --> Variable:
                              #         $SAVE_DIRECTORY
                              # --> Function:
...
<!DOCTYPE html><html><head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
			<TITLE>Upload Completed</TITLE><meta http-equiv="REFRESH" content="0; URL=/cgi-bin/admin/windows_client_background_select_fm.cgi">
		</HEAD>
