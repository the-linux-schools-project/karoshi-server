...
echo ""
echo '<!DOCTYPE html><html><head><meta http-equiv="Content-Type" content="text/html; charset=utf-8"><title>'$"Computer Logs"'</title><link rel="stylesheet" href="/css/'"$STYLESHEET"'?d='"$VERSION"'"><script src="/all/stuHover.js" type="text/javascript"></script>
...
do
	...
	#View logs
	echo "$REMOTE_USER:$REMOTE_ADDR:$Checksum:$TCPIP:$DAY:$MONTH:$YEAR:$DETAILED:$MOBILE:" | sudo -H /opt/karoshi/web_controls/exec/dg_view_computer_logs
	EXEC_STATUS="$?"
	if [ "$EXEC_STATUS" = 101 ]
	then
