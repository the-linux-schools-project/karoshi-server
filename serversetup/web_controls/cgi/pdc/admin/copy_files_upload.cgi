...
#
system "[ -d /var/www/karoshi/web_upload ] && rm -f -R /var/www/karoshi/web_upload";
system "mkdir -p /var/www/karoshi/web_upload";
system "chmod 0700 /var/www/karoshi/";
system "chmod 0700 /var/www/karoshi/web_upload";
BEGIN {

	$SAVE_DIRECTORY = "/var/www/karoshi/web_upload";
                              #
                              # --> Variable:
                              #         $SAVE_DIRECTORY
                              # --> Function:
...
__END_OF_HTML_CODE__
	...
	if ($SUCCESS_LOCATION !~ /^\s*$/) {
		...
		<HTML>
		<HEAD>
			<TITLE>Upload Completed</TITLE><meta http-equiv="REFRESH" content="0; URL=/cgi-bin/admin/copy_files_select_fm.cgi">
		</HEAD>
