...
function showHide(type){
	...
	document.getElementById("NewPrimaryGroup").style.display = "block";
	} else {
	document.getElementById("NewPrimaryGroup").style.display = "none";
	}
}
</script>
</head>
...
<tr><td>'$"Option"'</td><td>
<select onchange="showHide(this.value)" name="_OPTIONCHOICE_" style="width: 200px;">
...
<tr><td></td><td style="display: none;" id="NewPrimaryGroup">'
/opt/karoshi/web_controls/group_dropdown_list | sed 's/_GROUP_/_NEWGROUP_/g'
echo '</td><td></td></tr>
<tr><td>
'$"Exceptions"'
</td><td>
...
<tr><td>'$"Modify Code"'</td><td style="vertical-align: top; text-align: left;"><b>'"$MOD_CODE"'</b></td><td></td></tr>
