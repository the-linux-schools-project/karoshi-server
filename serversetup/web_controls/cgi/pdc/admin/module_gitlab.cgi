...
echo ""
echo '<!DOCTYPE html><html><head><meta http-equiv="Content-Type" content="text/html; charset=utf-8"><title>'$"Setup Gitlab"'</title><link rel="stylesheet" href="/css/'$STYLESHEET'?d='$VERSION'"><script src="/all/stuHover.js" type="text/javascript"></script></head><body><div id="pagecontainer">'
...
Checksum=`sha256sum /var/www/cgi-bin_karoshi/admin/module_gitlab.cgi | cut -d' ' -f1`
echo "$REMOTE_USER:$REMOTE_ADDR:$Checksum:$ALIAS:$SERVERNAME:" | sudo -H /opt/karoshi/web_controls/exec/module_gitlab
EXEC_STATUS=$?
if [ $EXEC_STATUS = 101 ]
then
