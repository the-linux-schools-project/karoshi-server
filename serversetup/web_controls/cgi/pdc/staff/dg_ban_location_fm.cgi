...
echo '<form action="/cgi-bin/staff/dg_ban_location.cgi" method="post"><div id="actionbox"><b>'$TITLE1'</b> <a class="info" href="javascript:void(0)"><img class="images" alt="" src="/images/help/info.png"><span>'$HELPMSG1'</span></a><br><br>'
###############################
#Location
###############################
